...
const Card = ({movie}) => {
  ...
  const imgURL = poster_path ? `https://image.tmdb.org/t/p/w500/${poster_path}` : BackupImage;
  return (
    <div>
      <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-100 m-3">
        <Link to={`/movie/${id}`}>
