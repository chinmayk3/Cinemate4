...
export const Header = () => {
  ...
  const activeClass = "block py-2 px-3 bg-blue-100 rounded md:bg-transparent md:text-blue-700 md:p-0 md:dark:text-blue-500";
  const inActiveClass = "block py-2 px-3 text-gray-600 rounded md:bg-transparent  md:p-0 md:dark:text-slate-100";
